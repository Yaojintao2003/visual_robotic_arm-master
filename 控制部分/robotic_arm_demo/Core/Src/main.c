...
//        servo_reset_begin();
//        HAL_Delay(100);
    /*YJT  temp_x = center_x,temp_y = center_y,temp_color = color_type;
        HAL_Delay(200);
        ...
        HAL_Delay(100);
				*/  
		//	pwm_out(180,0,0,0,0,30);
		double angle_1=60;
			double pulse_1=(((angle_1 + 70) / 90 ) + 0.5)*(20000/20);
			__HAL_TIM_SetCompare(&htim2, TIM_CHANNEL_4, 16000);
